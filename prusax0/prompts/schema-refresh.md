...
If `/Users/leo/.pi/agent/prusax0/schemas.json` is missing:
...
python3 /Users/leo/.pi/agent/prusax0/hooks/lib/schema_extract.py --discover <workspace>

# Extract/refresh configured schemas
python3 /Users/leo/.pi/agent/prusax0/hooks/lib/schema_extract.py
```
