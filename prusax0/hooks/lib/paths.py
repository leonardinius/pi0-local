...
QUERIES_FILE = os.path.join(LONG_TERM_DIR, "queries.md")
...
SCHEMAS_CONFIG = os.path.join(RESOURCE_ROOT, "schemas.json")
SCHEMAS_INDEX = os.path.join(SCHEMAS_DIR, "_tables.md")
